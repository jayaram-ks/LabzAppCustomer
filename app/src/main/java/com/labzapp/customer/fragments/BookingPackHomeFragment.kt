...
class BookingPackHomeFragment : Fragment() , GoogleMap.OnMyLocationButtonClickListener,
    ...
    val ZOOM_LEVEL = 16f
    private var _binding: FragmentBookingPackHomeBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBookingPackHomeBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.continueBookBtn.setOnClickListener {
            ...
            if(errmessage != null) {
                ...
                var arrayBookData = BookingDataPackTransfer(patbookfor.toString(),patlatitude,patlongitude,patprefdate,param1.toString())
                val bundle = Bundle()
                bundle.putString("param1", Json.encodeToString(arrayBookData))
                val prevFragment = BookingPackPreviewFragment()
    ...
    private fun checkGpsStatus() {
        ...
        if (gpsStatus) {
            ...
            snackze(requireView(),"Please enable Location service(GPS) on your Device",binding.buttonDate1.id)
            lifecycleScope.launch {
                delay(2000)
                gpsStatus()
            }
        ...
        requestCall.enqueue(object : Callback<SinglePackResponse> {
            ...
            override fun onResponse(call: Call<SinglePackResponse>, response: Response<SinglePackResponse>) {
                ...
                if (resp?.code == 200) {
                    ...
                    view?.let{ snackze(it,resp?.message.toString(),binding.buttonDate1.id) }
                }
            }

            override fun onFailure(call: Call<SinglePackResponse>, t: Throwable) {
                view?.let{ snackze(it,t.message.toString(),binding.buttonDate1.id) }
            }
        })
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String) =
            BookingPackHomeFragment().apply {
                arguments = Bundle().apply {
                    putString(ARG_PARAM1, param1)
                }
            }
        private const val LOCATION_PERMISSION_REQUEST_CODE = 1
        const val TAG = "BookingPackHomeFragment"
    }
}